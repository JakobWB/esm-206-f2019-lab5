...
I am going to add a new column with 'mutate()', that contains my date as an actual date.
...
Parse 'Date' column to get the different pieces (month,year) seperated.
...
Let us say I want to count the number of lobsters by year and month
```{r}
